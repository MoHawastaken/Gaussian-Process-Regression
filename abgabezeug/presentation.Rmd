...
- Regression: Vorhersage des Prozesses zu anderen Zeitpunkten

- Klassifikation: Vorhersage der Zugehörigkeit von Beobachtungen zu verschiedenen Klassen
...
Gaussian <- GPR.sqrexp$new(X, y, noise, 1)
Gaussian$plot()$plot
message("The chosen covariance function is sqr.exp")
```
