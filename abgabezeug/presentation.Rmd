...
>- Wird charakterisiert über $m(x)=\erw{f(x)}$ und $k(x,x')=\text{Cov}(f(x),f(x'))$. 
...
Methode:
Hier noch was ergänzen

- Maximierung der Marginal Log-Likelihood 
- Newton Methode, `optim()`

Marginal Log-Likelihood: Wahrscheinlichkeit für diese Beobachtungen gegeben eine bestimmte Kovarianzfunktion
