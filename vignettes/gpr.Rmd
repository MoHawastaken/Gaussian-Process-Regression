...
- constant, $k(x,y) = c$,
- linear, $k(x,y) = \sum_{d=1}^D \sigma_d \cdot x_d \cdot y_d$,
- polynomial, $k(x,y) = (x \cdot y + \sigma)^p$,
- squared exponential, $k(x,y) = \exp\left(-\frac{|x-y|^2}{2 l^2}\right)$,
- gamma exponential, $k(x,y) = \exp \left(-\left( \frac{|x-y|}{l} \right)^\gamma \right)$,
